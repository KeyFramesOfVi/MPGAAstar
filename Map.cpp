...
void Map::addWall(string lab, int x1, int y1, int x2, int y2){
...
void Map::addVirtualWall(string lab, int x1, int y1, int x2, int y2){
...
bool Map::isPathCrossesBuffer(int x0, int y0, int x1, int y1){
    vector<MapWall>::iterator iter;
    for( iter = walls.begin(); iter != walls.end(); iter++ ){
        vector<MapWallBuffer> buffers = iter->getWallBuffers();
        vector<MapWallBuffer>::iterator it;
...
bool Map::isPointInBuffer(int x, int y){
    ...
    vector<MapVirtualWall>::iterator it;
